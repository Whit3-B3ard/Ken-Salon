  ...
  return (
    <>
      ...
      <div className="w-full h-full flex">
        <div className="h-full w-2/3 flex flex-col items-center mt-8">
          <div className="h-4/5 w-4/5 rounded-xl">
            ...
            <Swiper
              ...
              onSlideChange={(swiper) => {
                ...
                setTimeout(updateSwiperHeight, 5000); // Allow time for slide change before updating height
              }}
              ref={swiperRef}
        ...
        <div className="h-full w-1/3 flex justify-end ">
          <div className="fixed h-3/4 w-1/4  border-2 border-gray-500 rounded-xl mr-14 flex flex-col bg-gray-100 basket">
              ...
              {basket.map((item, index) => (
                ...
                >
                  <img
                    src={item.imageUrl}
                    alt="Service"
                    className="w-24 h-24 object-cover rounded-xl" // Small image with some margin
                  />
            ...
            <div className="w-full h-1/6 flex justify-center items-center">
              {basket.length > 0 ? (
                <Link href="/services/dubai/for-her/schedule">
