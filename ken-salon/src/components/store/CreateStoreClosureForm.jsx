...
const CreateStoreClosureForm = () => {
  ...
  return (
    <>
      ...
      {isFormVisible && (
        <div className='ml-4'>
        <form onSubmit={handleSubmit} className="space-y-4 flex flex-col w-1/4 ">
