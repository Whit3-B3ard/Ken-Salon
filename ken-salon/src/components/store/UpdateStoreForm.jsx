...
const inputStyle = "text-black px-4 py-2 border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 w-1/3"
  ...
  return (
    <div >
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 items-center">
        <input  className="text-black px-4 py-2 border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 w-1/3 mt-4"  type="text"  name="name"  placeholder="Store Name"  value={storeData.name}  onChange={handleChange} />
        ...
        <button
          type="submit"
          className="mt-4 px-4 py-2 mb-4 bg-blue-500 text-white font-semibold rounded-lg hover:bg-blue-600"
        >
          Update Store
        </button>
      </form>
