  ...
  return (
    <>
      ...
      {isFormVisible && (<form onSubmit={handleSubmit} className="flex flex-col gap-4 p-4 max-w-md mx-auto">
        ...
        <button type="submit" disabled={isLoading} className="mx-auto lg:mx-0 hover:underline bg-indigo-500 text-white font-bold rounded-full mt-4 lg:mt-0 py-4 px-4 shadow  focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
