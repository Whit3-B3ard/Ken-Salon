        ...
        <div>
            ...
            <ul className="list-disc pl-5">
                {filteredAvailabilities.map((availability) => (
                    <li key={availability._id} className="mb-3">
                        ...
                        {/* <p className="mb-2">
                            <span className="font-medium">Dates</span> {availability.dates}
                        </p> */}
            ...
            <form onSubmit={editingAvailabilityId ? handleUpdateAvailabilitySubmit : handleAddAvailabilitySubmit} className="mt-4">
                ...
                {/* <div className="date-picker-wrapper">
                        <ReactDatePicker
                            inline // Display the date picker inline for easier multiple date selection
                            selected={null} // Prevent highlighting a specific date
                            onChange={handleDateChange}
                            multiple // This prop doesn't exist in ReactDatePicker by default, indicating the need for a custom solution or component modification
                            highlightDates={newAvailability.dates.map(dateString => new Date(dateString))}
